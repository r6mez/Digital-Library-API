...
const { createActivateSubscriptionSchema } = require('../validators/activeSubscriptionValidator');
const validate = require('../validators/validate');

const { admin } = require('../middleware/adminMiddleware');

router.get('/', getSubscriptions);
router.post('/:id/activate', protect, validate(createActivateSubscriptionSchema), activateSubscription);
