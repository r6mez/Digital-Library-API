...
const getBooksData = (categories, types, authors) => {
  ...
  return [
    ...
    },
    {
      ...
      description:
        "A romantic novel that follows the character development of Elizabeth Bennet, the dynamic protagonist.",
    ...
    },
    {
      ...
      description:
        "Hercule Poirot investigates a murder aboard the famous European train.",
    ...
    },
    {
      ...
      description:
        "A science fiction novel about mathematician Hari Seldon who develops psychohistory to predict the future.",
    ...
    },
    {
      ...
      description:
        "A modernist novel that examines the thoughts and experiences of the Ramsay family.",
    ...
    },
    {
      ...
      description:
        "The adventures of a boy and his friend Jim, an escaped slave, as they travel down the Mississippi River.",
    ...
    },
    {
      ...
      description:
        "An autobiographical account of Angelou's early years and the racism and trauma she experienced.",
    ...
    },
    {
      ...
      description:
        "The story of an aging Cuban fisherman who struggles with a giant marlin far out in the Gulf Stream.",
    ...
    // Additional books for more variety
    {
      ...
      description:
        "A comprehensive guide to computer science fundamentals and programming concepts.",
    ...
    },
    {
      ...
      description:
        "An in-depth exploration of world history from ancient civilizations to modern times.",
    ...
    },
    {
      ...
      description:
        "Practical techniques for developing mindfulness and reducing stress in daily life.",
    ...
    },
    {
      ...
      description:
        "Key strategies and frameworks for developing successful business plans and operations.",
    ...
    },
    {
      ...
      description:
        "A visual journey through the major art movements of the 20th and 21st centuries.",
